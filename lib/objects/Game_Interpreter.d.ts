...
import { ActorID, CharacterID, CommandCode, CommandParams, DataCommand, ExtractDataCommand, EnemyID, EventID, MapID, ValueOperation, VariableID, VariableOperationType, WaitMode, ActionTarget } from "../data";
