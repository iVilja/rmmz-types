...
- [utils](#utils)
  - [ChangeActorValue (type alias)](#changeactorvalue-type-alias)
  - [ChangeEnemyValue (type alias)](#changeenemyvalue-type-alias)
  - [CommandCode (type alias)](#commandcode-type-alias)
  - [CommandParams (type alias)](#commandparams-type-alias)
  - [ConditionalBranchParams (type alias)](#conditionalbranchparams-type-alias)
  - [DataCommand (type alias)](#datacommand-type-alias)
  - [ExtractDataCommand (type alias)](#extractdatacommand-type-alias)
  - [IterateActorArguments (type alias)](#iterateactorarguments-type-alias)
  - [MoveRoute (interface)](#moveroute-interface)
  - [RouteCommandCode (type alias)](#routecommandcode-type-alias)
  - [RouteMovementCommand (type alias)](#routemovementcommand-type-alias)
  - [ShopGoods (type alias)](#shopgoods-type-alias)
  - [TextWindowBackgroundType (type alias)](#textwindowbackgroundtype-type-alias)
  - [TextWindowPositionType (type alias)](#textwindowpositiontype-type-alias)
  - [ValueOperand (type alias)](#valueoperand-type-alias)
  - [ValueOperation (type alias)](#valueoperation-type-alias)
  - [VariableComparisonType (type alias)](#variablecomparisontype-type-alias)
  - [VariableOperationType (type alias)](#variableoperationtype-type-alias)
  - [WaitMode (type alias)](#waitmode-type-alias)
